...
//static const int64_t COIN_YEAR_REWARD2 = COIN_YEAR_REWARD;

//inline bool IsRewardHF(int nHeight) { return TestNet() || nHeight > 1; } // initialize fixed 1 COIN (with halving) + 6% reward
//inline bool IsProtocolV2(int nHeight) { return TestNet() || nHeight > 589289; } // 589289 HWT  HardFork to v2 Protocol
