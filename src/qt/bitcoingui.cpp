...
{
    resize(850+95, 550);
    setWindowTitle(tr("HewettCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/hewettcoin"));
    setWindowIcon(QIcon(":icons/hewettcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a HewettCoin address"));
    ...
    aboutAction = new QAction(tr("&About HewettCoin"), this);
    aboutAction->setToolTip(tr("Show information about HewettCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for HewettCoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/hewettcoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/hewettcoin_testnet"));
            setWindowIcon(QIcon(":icons/hewettcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/hewettcoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("HewettCoin client") + QString(" ") + tr("[testnet]"));
                trayIcon->setIcon(QIcon(":/icons/hewettcoin_testnet-16"));
                toggleHideAction->setIcon(QIcon(":/icons/hewettcoin_testnet-16"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("HewettCoin client"));
    trayIcon->setIcon(QIcon(":/icons/hewettcoin"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HewettCoin network", "", count));
}
...
{
    QString strTitle = tr("HewettCoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid HewettCoin address or malformed URI parameters."));
    }
