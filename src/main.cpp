...
#if defined(NDEBUG)
# error "HewettCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "HewettCoin Signed Message:\n";
...
//        int64_t nSearchInterval = IsProtocolV2(nBestHeight+1) ? 1 : nSearchTime - nLastCoinStakeSearchTime;
        int64_t nSearchInterval = nBestHeight+1 ? 1 : nSearchTime - nLastCoinStakeSearchTime;
...
{
    RenameThread("hewettcoin-loadblk");
